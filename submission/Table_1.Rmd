...
\small
\centering
\begin{tabular}{>{\centering\arraybackslash}m{4cm}|>{\centering\arraybackslash}m{7cm}|>{\centering\arraybackslash}m{5cm}}
...
Create a list & Use the GitHub template to create a self-nomination list and resource for your field & Template can be found at https://github.com /diversifymicrobiology /DiversifyMicrobiology.github.io \\\hline
...
Encourage trainees to engage & When a talk is over, ensure that trainees are the first to ask questions & \\\hline
